...
// --- MOTOR DE CONEXÃO DERIV (WEBSOCKET COM APP ID CORRIGIDO) ---
btnConnectDeriv.addEventListener('click', () => {
    ...
    // Conectando via WebSocket oficial utilizando o App ID 1 (Livre de bloqueios CORS)
    ...
    ws.onmessage = (msg) => {
        ...
        // Se a Deriv retornar erro no token enviado
        if (response.error) {
